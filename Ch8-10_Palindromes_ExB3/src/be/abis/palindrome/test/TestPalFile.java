...
public class TestPalFile {
    ...
    public static void main(String[] args) {
        ...
        try (FileReader fr = new FileReader("Ch8-10_Palindromes_ExB3/src/palindromes.txt");
             BufferedReader br = new BufferedReader(fr);
             PrintWriter pw = new PrintWriter("Ch8-10_Palindromes_ExB3/src/palindromessorted.txt")){
            String line=null;
