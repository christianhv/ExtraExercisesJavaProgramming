...
public class TestMain {
    ...
    public static void main(String[] args) {
        ...
        Person pe1 = new Person("Ann","Smits",35,c);
        Person pe2 = new Person("Yvette","Van den Acker",70);
        Person pe3 = new Person("John","Doe",17);
        ...
        for (Person p : personsToSort){
            System.out.println(p + " (" + p.getAge() + " years old)");
        }
